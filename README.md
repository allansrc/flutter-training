...
### Advanced
- [Isolates and Event Loops](https://www.youtube.com/watch?v=vl_AaCgudcY&list=PLjxrf2q8roU2HdJQDjJzOeO6J3FoFLWr2&index=14)
...
## 3. State Management
### Provider
- [Official Documentation](https://pub.dev/packages/provider)
- [Provider Masterclass (PT-BR)](https://www.youtube.com/watch?v=VhsqMahAmOk)

### ChangeNotifier
- [Official Documentation](https://api.flutter.dev/flutter/foundation/ChangeNotifier-class.html)
- [ChangeNotifier + Provider](https://docs.flutter.dev/development/data-and-backend/state-mgmt/simple#:~:text=ChangeNotifier%20is%20a%20simple%20class,those%20familiar%20with%20the%20term.)
- [ChangeNotifier with AnimationBuilder (PT-BR)](https://blog.flutterando.com.br/changenotifier-o-incompreendido-sm-do-flutter-a7cafb13c61a)

### Bloc/Cubit
- [Official Documentation](https://bloclibrary.dev/#/gettingstarted)
- [Bloc Free Course - Flutterly](https://www.youtube.com/watch?v=THCkkQ-V1-8)
...
## 4. Service Locator & Route System
### Flutter Modular
